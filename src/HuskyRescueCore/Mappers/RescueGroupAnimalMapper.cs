        ...
        public List<RescueGroupAnimal> Map(string jsonObjectSourceString)
        {
            ...
            foreach (var animal in source.data)
            {
                ...
                var thisAnimal = new RescueGroupAnimal
                {
                    ...
                    AnimalCratetrained =
                        animal.Value.animalCratetrained != null ? animal.Value.animalCratetrained.Value : string.Empty,
                    AnimalDescription =
                        animal.Value.animalDescription != null ? animal.Value.animalDescription.Value : string.Empty,
                    AnimalEnergyLevel =
                        animal.Value.animalEnergyLevel != null ? animal.Value.animalEnergyLevel.Value : string.Empty,
                    AnimalExerciseNeeds =
                        animal.Value.animalExerciseNeeds != null ? animal.Value.animalExerciseNeeds.Value : string.Empty,
                    ...
                    AnimalHousetrained =
                        animal.Value.animalHousetrained != null ? animal.Value.animalHousetrained.Value : string.Empty,
                    AnimalLeashtrained =
                        animal.Value.animalLeashtrained != null ? animal.Value.animalLeashtrained.Value : string.Empty,
                    ...
                    AnimalNeedsFoster =
                        animal.Value.animalNeedsFoster != null ? animal.Value.animalNeedsFoster.Value : string.Empty,
                    AnimalOkWithAdults =
                        animal.Value.animalOKWithAdults != null ? animal.Value.animalOKWithAdults.Value : string.Empty,
                    ...
                    AnimalSpecialneeds =
                        animal.Value.animalSpecialneeds != null ? animal.Value.animalSpecialneeds.Value : string.Empty,
                    AnimalSpecialneedsDescription =
                        animal.Value.animalSpecialneedsDescription != null
                    ...
                    AnimalSummarypublic =
                        animal.Value.animalSummarypublic != null ? animal.Value.animalSummarypublic.Value : string.Empty,
                    AnimalThumbnailUrl =
                        animal.Value.animalThumbnailUrl != null ? animal.Value.animalThumbnailUrl.Value : string.Empty
                };
                ...
                foreach (var picture in animal.Value.animalPictures)
                {
                    thisAnimal.AnimalPictures.Add(new RescueGroupPicture
                    {
                        ...
                        UrlInsecureFullsize =
                            picture.urlInsecureFullsize != null ? picture.urlInsecureFullsize.Value : string.Empty,
                        UrlInsecureThumbnail =
                            picture.urlInsecureThumbnail != null ? picture.urlInsecureThumbnail.Value : string.Empty
                    });
                }

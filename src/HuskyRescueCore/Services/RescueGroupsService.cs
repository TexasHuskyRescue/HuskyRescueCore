...
namespace HuskyRescueCore.Services
{
    public class RescueGroupsService : IRescueGroupsService
    {
        ...
        public async Task<List<RescueGroupAnimal>> GetAdoptableHuskiesAsync()
        {
            ...
            var data = new
            {
                apikey = (await _systemServices.GetSettingAsync("RescueGroups-Api-Key")).Value,
                objectType = "animals",
            ...
            var request = (HttpWebRequest)WebRequest.Create(rescueGroupsApiUri);
            request.Method = "POST";
        ...
        public async Task<List<RescueGroupAnimal>> GetFosterableHuskiesAsync()
        {
            ...
            var requestStream = await request.GetRequestStreamAsync();
            await requestStream.WriteAsync(bytes, 0, (int)requestStream.Length);

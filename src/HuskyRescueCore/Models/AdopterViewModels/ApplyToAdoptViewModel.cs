...
{
    public class ApplyToAdoptViewModel
    {
        ...
        [Display(Name = "Where would your pet stay while you are out of town?")]
        ...
        [Display(Name = "This pet will be kept...")]
        ...
        [MaxLength(50, ErrorMessage = "number of hours pet left alone must be less than 50 characters")]
        ...
        [MaxLength(50, ErrorMessage = "number of days a week pet left alone must be less than 50 characters")]
        public string PetLeftAloneDays { get; set; }

        [Display(Name = "Where will this pet be kept while you are at work or away from home?")]
        ...
        [Display(Name = "Where will this pet sleep at night?")]
        ...
        [Display(Name = "Why do you want to adopt a husky at this time?")]
        [MaxLength(4000)]
        [DataType(DataType.MultilineText)]
        ...
        [Display(Name = "Are all adults in agreement about the adoption?")]
        ...
        [Display(Name = "Which of our huskies are you interested in?")]
        [DataType(DataType.MultilineText)]
        [MaxLength(4000)]
        ...
        [Display(Name = "There is a non-refundable application fee required to process your application. The fee will be applied to your adoption fee if you are approved.")]
